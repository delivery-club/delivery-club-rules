	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 158,
				SyntaxPatterns: []ir.PatternString{
					{Line: 158, Value: "if $*_, $err = $f($*args); $err != nil { return $err }; return nil"},
					{Line: 159, Value: "if $*_, $err := $f($*args); $err != nil { return $err }; return nil"},
					{Line: 160, Value: "$*_, $err = $f($*args); if $err != nil { return $err }; return nil"},
					{Line: 161, Value: "var $*_, $err = $f($*args); if $err != nil { return $err }; return nil"},
					{Line: 162, Value: "$*_, $err := $f($*args); if $err != nil { return $err }; return nil"},
					{Line: 163, Value: "if $*_, $err = $f($*args); $err != nil { return $err }; return $err"},
					{Line: 164, Value: "if $*_, $err := $f($*args); $err != nil { return $err }; return $err"},
					{Line: 165, Value: "$*_, $err = $f($*args); if $err != nil { return $err }; return $err"},
					{Line: 166, Value: "var $*_, $err = $f($*args); if $err != nil { return $err }; return $err"},
					{Line: 167, Value: "$*_, $err := $f($*args); if $err != nil { return $err }; return $err"},
				},
